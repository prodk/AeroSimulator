...
bool CBoundingBox::collidesWith(const CBoundingBox & box) const
{
   bool result = false;
   ...
   const float deltaZ2 = (translate.z - myTranslate.z)*(translate.z - myTranslate.z);
   if (std::sqrt(deltaZ2) <= 1.0f)
   {
      result = true;
   }
