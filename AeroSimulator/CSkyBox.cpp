   ...
   : CCube()
{
   ...
   //mTexturedCubeGeometry->setVertexBuffer(vertices);
   //const int numOfVertices = sizeof(vertices) / sizeof(vertices[0]);
   //mTexturedCubeGeometry->setNumOfVertices(numOfVertices);

   //mTexturedCubeGeometry->setIndexBuffer(indices);
   //const int numOfIndices = sizeof(indices) / sizeof(indices[0]);
   //mTexturedCubeGeometry->setNumOfIndices(numOfIndices);

   /////@todo: get rid of the magic numbers
   //mTexturedCubeGeometry->setNumOfElementsPerVertex(CCube::mNumOfElementsPerVertex); ///@todo: may be 5
   //mTexturedCubeGeometry->setVertexStride(CCube::mStride); //5
